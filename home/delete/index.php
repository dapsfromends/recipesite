          ...
          <div class="navbar-collapse justify-content-end px-0" id="navbarNav">
            <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
              <li class="nav-item dropdown">
                <a class="nav-link nav-icon-hover" href="/home/edit/one?" id="drop2" data-bs-toggle="dropdown"
                  aria-expanded="false">
        ...
        <div class="row">
          ...
          if ($result_top5->num_rows > 0) {
            while ($row = $result_top5->fetch_assoc()) {
              ...
              echo '<a href="/home/delete/delete.php?id=' . $id . '" class="bg-danger rounded-circle p-2 text-white d-inline-flex position-absolute bottom-0 end-0 mb-n3 me-3" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add To Cart"><i class="ti ti-trash"></i></a></div>';
              echo '<div class="card-body pt-3 p-4">';
              echo '<h6 class="fw-semibold fs-4">' . $title . '</h6>';
              echo '<div class="d-flex align-items-center justify-content-between">';
              echo '<h6 class="fw-semibold fs-4 mb-0"><a href="/home/delete/delete.php?id=' . $id . '">' . $chefname . ' </a></h6>';
              echo '</div>';
              echo '</div>';
              echo '</div>';
              echo '</div>';
